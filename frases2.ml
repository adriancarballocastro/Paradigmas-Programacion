...
(function y -> x+y) ( 5 );;		(*Suma los dos valores con el nuevo de y sin modificarlo*)
x+y;;				(*Suma x e y*)
(function x -> (function y -> x + y + z)(x*y))(x+y);;		(*Suma los 3 valores con nuevos sin modificalos*)
